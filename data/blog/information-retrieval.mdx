...
idea relate a lot to "query language" and the use of advanced search techniques that everyone knows about such "site:website", but no one actually considers to use on a consistent
basis.
