...
The **main difference** between Wasserstein GAN and regular GAN is that it uses linear activation instead of sigmoid in discriminator and reducse the logs in
