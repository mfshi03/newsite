...
the anchor and the negative term. Additionally, sometimes we want the distance between our two embedding distances to be greater hence why we have a slack $\alpha$.
