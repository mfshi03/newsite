...
the anchor and the negative term. Additionally, sometimes we want the distance between our embedding distance to be greater hence why we have a slack $\alpha$.
...
<figure style={{
  ...
  <img src="/static/images/transformer-latent.png" style={{width: '75%', height: '75%'}}/>
...
For those who want more interpretability of the model, there are dimensionality reduction 
techniques to visualize and understand these embeddings such as t-SNE and UMAP.
...
<figure style={{
  ...
  />
  <figcaption>Visualization of YouTube video embeddings with t-SNE (Use arrow keys to explore)</figcaption>
</figure>
{/*
