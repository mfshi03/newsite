---
title: Quant Trading Interview Preparation
date: '2022-09-25'
tags: ['Math', 'Interviews']
draft: false
summary: 'In this article, I talk about how I prepared for quant-trading interviews'
authors: ['default']
---

This is a compilation of the resources I have used for interviewing with Jane Street in Fall 2022. 

The first link here:  [Useful Advice](https://www.wallstreetoasis.com/forum/trading/jane-street-capital-first-round-phone-interview) is some good general advice to read before going into these type of interviews to know what to expect.
