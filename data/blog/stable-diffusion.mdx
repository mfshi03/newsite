...
<figcaption text-align="center" width="85%" margin="10px auto 35px" line-height={1.35} color="grey-color" font-style="italic" >Figure 1. How the autoencoder converts input data into latent variables</figcaption>

<figure>
        <img src="/static/images/autoencoder.png"/>
        <figcaption text-align="center" width="85%" line-height={1.35} font-style="italic" >Figure 1. How the autoencoder converts input data into latent variables</figcaption>
</figure>